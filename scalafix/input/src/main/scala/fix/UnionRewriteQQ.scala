...
object UnionRewriteQQ {
  ...
  def inSource3(spark: SparkSession): Unit = {
    ...
    val res = dss.reduce(_ unionAll _)
  }
  ...
  def inSource5(spark: SparkSession): Unit = {
    ...
    val r = ds1.unionAll(ds2).unionAll(ds3)
  }
  ...
  def inSource7(
    ...
    val res1 = ds1.unionAll(ds2).unionAll(ds3)
    val res2 = ds1.unionAll(ds3)
  }
  ...
  def inSource8(
    ...
    val res1 = df1.unionAll(df2).unionAll(df3)
    val res2 = df1.unionAll(df3)
    val res3 = df1.unionAll(df2).unionAll(df3).unionAll(df4)
  }
